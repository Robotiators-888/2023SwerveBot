...
public class CMD_DriveToTarget extends CommandBase {
  ...
  private final PIDController omegaController = new PIDController( 1, 0, 0); // 2, 0, 0
  ...
  public void execute() {
    ...
    if (targetTransform != null){
        ...
        var xSpeed = xController.calculate(0, targetTransform.getZ()-0.5);
       ...
       var omegaSpeed = omegaController.calculate(0, targetTransform.getRotation().getY());
        ...
        drivetrain.drive(0.05 *xSpeed, -0.05*ySpeed, -0.25*omegaSpeed, false, true);
    } else {
